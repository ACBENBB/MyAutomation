...
pipeline {
    ...
    parameters {
        ...
        string(name: 'issuerId', defaultValue: 'null', description: 'Issuer Id on which to add investor')
    ...
    stages {
        ...
        stage('Build & Run script') {
            steps {
                script {
                    mainLoader.mavenCleanAndCompile("e2e/AUT446_AssociateSidInvestorToIssuer.xml")
