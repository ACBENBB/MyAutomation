...
public class PierAPIData {
    private static Properties properties = null;
    private static final String PROPERTY_FILE_NAME = "PierAPIData/LegacyPierAPI.properties";

    private static void init() {

        if (properties == null) {
            try {
                InputStream input = PierAPIData.class.getClassLoader().getResourceAsStream(PROPERTY_FILE_NAME);
    ...
    public static String getProperty(PierAPIProperty propertyName) {
