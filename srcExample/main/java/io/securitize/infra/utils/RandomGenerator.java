...
public class RandomGenerator {
	...
	public static String randomEmail(int numOfChars) {
		String[] emailParts = Users.getProperty(UsersProperty.automationMailUsername).split("@");
		return  emailParts[0] + "+" + RandomGenerator.randomString(numOfChars) + "@" + emailParts[1];
	}
