...
public class DepositInternationalWireModalPage extends AbstractPage {
    ...
    private static final ExtendedBy swiftCodeTitle = new ExtendedBy("Swift Code title", By.cssSelector("[data-test-id='ca-depositinfo-swiftcode-title']"));
    private static final ExtendedBy swiftCodeValue = new ExtendedBy("Swift Code value", By.cssSelector("[data-test-id='ca-depositinfo-swiftcode-value']"));
    ...
    public DepositInternationalWireModalPage(Browser browser) {
    ...
    public String getSwiftCodeTitle() {
        return browser.getElementText(swiftCodeTitle);
    }

    public String getSwiftCodeValue() {
        return browser.getElementText(swiftCodeValue);
    }
