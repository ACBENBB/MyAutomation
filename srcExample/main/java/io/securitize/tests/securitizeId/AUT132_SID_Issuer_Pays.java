...
public class AUT132_SID_Issuer_Pays extends AbstractDelayedUiTest {

    @Test(description = "AUT132 - Register investor including register wallet, execute TBE issuance, " +
            "authorize asset using Issuer Pays & transfer tokens from TBE to the asset-authorized wallet")
    @UseLegacyWalletDetails
    @UsingMetaMask
    public void AUT132_SID_Issuer_Pays_Test() throws Exception {
        ...
        String walletStatus = investorsAPI.getTokensAndWallets(issuerName, issuerInvestorId, tokenId)
        ...
        //sign pending tokens' reallocation txn (ReallocateTokens)
