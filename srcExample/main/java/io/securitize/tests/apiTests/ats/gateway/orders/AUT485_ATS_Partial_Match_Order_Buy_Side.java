...
public class AUT485_ATS_Partial_Match_Order_Buy_Side {

    @Test(description = "Creates a 'Buy' order to partially match a sell order", groups = {"apiSanityATS"})
    @AtsMarketDependent(expectedState = AtsMarketState.UP)
    public void AUT485_ATS_Partial_Match_Order_Buy_Side() throws InterruptedException {
        ...
        HashMap<String, String> buyOrder = user1.createOrder(tokenName, Orders.SIDE.B.name(), "2", "1");
        ...
        HashMap<String, String> sellOrder = user2.createOrder(tokenName, Orders.SIDE.S.name(), "1", "1");
