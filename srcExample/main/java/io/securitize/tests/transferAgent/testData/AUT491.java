...
public class AUT491 {
    ...
    public AUT491() {
        ...
        this.investorType = AbstractTaxForm.TaxFormAutoCompleteInvestorType.ENTITY_NONUS_ACCEPT.toString();
        this.testInvestorMail = Users.getProperty(UsersProperty.ta_taxforms_ent_nonus_accept_Email_aut491);
