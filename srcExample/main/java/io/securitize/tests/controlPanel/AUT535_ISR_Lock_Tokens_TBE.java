...
public class AUT535_ISR_Lock_Tokens_TBE extends AbstractCpInvestorRegistrationFlow {

    @Test(description = "AUT535 - Lock TBE token")
    public void AUT535_ISR_Lock_Tokens_TBE_test() {

        startTestLevel("Define Test Scenario and Create Test Data Object");
        AbstractCpInvestorRegistrationFlow.ISR_TestScenario testScenario = ISR_TestScenario.AUT535_ISR_Lock_Tokens_TBE;
